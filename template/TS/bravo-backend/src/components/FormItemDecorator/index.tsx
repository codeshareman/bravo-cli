...
class FormItemDecorator extends Component<P, S> {
  render() {
    const { children, form, options = {}, label, required = false, field, validator, itemType, ...rest } = this.props
    ...
    const ele = children ? children : itemType ? FormItemChildren[itemType] : null
